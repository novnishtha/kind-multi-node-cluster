...
spark = SparkSession.builder.appName("JobTransformationsWithoutAQE").getOrCreate()
# Disable Adaptive Query Execution (AQE) for performance comparison
...
print(f"Time taken for 'Entertainment' analysis: {end_time_entertainment - start_time_entertainment:.2f} seconds")  #8.98 sec
...
print(f"Time taken for 'Gambling' analysis: {end_time_gamb_spenders - start_time_gamb_spenders:.2f} seconds")   #6.36 sec
...
print(f"Time taken for 'Average Monthly Spending' analysis: {end_time_avg_monthly_spend - start_time_avg_monthly_spend:.2f} seconds")   #72.43 sec
...
print(f"Time taken for 'Join and Aggregate' analysis: {end_time_join - start_time_join:.2f} seconds")   #17.38 sec
...
print(f"Time taken for 'Top 3 Cities' analysis: {end_time_top_cities - start_time_top_cities:.2f} seconds")    #16.41 sec
